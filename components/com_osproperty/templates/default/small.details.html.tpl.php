...
<table class="sTable">
	<tr>
			...
			if($my_agent_id == $row->agent_id){
				...
				<span id="compare_3">
					<a href="<?php echo $link?>" title="<?php echo JText::_('OS_EDIT_PROPERTY')?>">
						<img src="<?php echo JURI::root()?>components/com_osproperty/images/assets/edit16.png" border="0" />
					</a>
				</span>
				<?php
			}
		...
		<span id="compare_3">
			...
			<img class="png" title="<?php echo JText::_('OS_ADD_TO_COMPARE_LIST')?>" alt="<?php echo JText::_('OS_ADD_TO_COMPARE_LIST')?>" src="<?php echo JURI::root()?>components/com_osproperty/images/assets/compare.png" /></a>
		</span>
		<?php
		}
		...
		<span id="favorite_3">
			...
			<img title="<?php echo JText::_(OS_ADD_TO_FAVORITES)?>" alt="<?php echo JText::_(OS_ADD_TO_FAVORITES)?>" src="<?php echo JURI::root()?>components/com_osproperty/images/assets/savefavorites.png" /></a>
		</span>
		<?php
		}
		...
		?>
			...
			<img alt="<?php echo JText::_(OS_EXPORT_PDF)?>" title="<?php echo JText::_(OS_EXPORT_PDF)?>" src="<?php echo JURI::root()?>components/com_osproperty/images/assets/tpdf.png" /></a>
		<?php
		}
		if($configs[58]->fieldvalue == 1){
		?>
			<a target="_blank" href="index.php?option=com_osproperty&no_html=1&task=property_print&id=<?php echo $row->id?>"><img alt="<?php echo JText::_(OS_PRINT_THIS_PAGE)?>" title="<?php echo JText::_(OS_PRINT_THIS_PAGE)?>" src="<?php echo JURI::root()?>components/com_osproperty/images/assets/print.gif" /></a>
		<?php
		}
		?>
		</td>
