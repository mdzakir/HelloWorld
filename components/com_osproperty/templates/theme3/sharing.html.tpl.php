...
<form method="POST" action="<?php echo JURI::root()?>index.php?option=com_osproperty&task=property_submittellfriend&Itemid=<?php echo $itemid?>&tmpl=component" name="tellfriend_form" id="tellfriend_form" class="form-horizontal">
