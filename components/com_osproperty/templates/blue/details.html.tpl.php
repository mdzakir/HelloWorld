	...
	<div class="row-fluid">
		...
		<div class="span<?php echo $span;?>">
	            ...
	            <div class="span6">
	            	<div class="descriptionWrap">
	                    ...
	                    <ul class="attribute-list">
	                        ...
	                        if(file_exists(JPATH_ROOT.DS."components".DS."com_oscalendar".DS."oscalendar.php")){
								if(($configClass['integrate_oscalendar'] == 1) and (in_array($row->pro_type,explode("|",$configClass['show_date_search_in'])))){
                                    ...
                                    if($count > 0) {
                                        ?>
                                        <li>
                                            <span class="btn btn-info" style="width:80%;">
                                                <a href="#oscalendardiv"
                                                   style="color:white;font-weight:bold;text-decoration:none;"><?php echo JText::_('OS_BOOK_NOW')?></a>
                                            </span>
                                        </li>
                                    <?php
                                    }
	                        ...
	                        if(($configClass['show_rating'] == 1) and ($row->number_votes > 0)){
	                        ?>
	                        <li>
	                        	<div style="padding-top:10px;text-align:center;">
		                        	<span class="fontlargeb blue"><?php echo $row->cmd;?></span>
		                        	<div class="dpurple">
										<p class="fontxlargeb blue">
											<span><?php echo $row->rate;?></span>
										</p>
										<p class="black fontsmallb">
											<span>
											<?php echo JText::_('OS_BASED_ON');?>
											<?php echo $row->number_votes;?> <?php echo JText::_('OS_REVIEWS');?>
											<br>
											</span>
										</p>
									</div>
	        ...
	        <div class="row-fluid clearfix">
				...
				<span class="">
					<?php echo stripslashes(OSPHelper::getLanguageFieldValue($row,'pro_small_desc'));?>
				</span>
			</div>
	    </div>
	    <!-- end content -->
					...
					<div class="tabs clearfix">
					    <div class="tabbable">
					        <ul class="nav nav-tabs">
					        	...
					        	if($configClass['show_agent_details'] == 1){
					        	?>
					            <li class="<?php echo $agent_div?>"><a href="#agenttab" data-toggle="tab">
								<?php 
								if($row->agenttype == 0){
...
if(file_exists(JPATH_ROOT.DS."components".DS."com_oscalendar".DS."oscalendar.php")){
	if(($configClass['integrate_oscalendar'] == 1) and (in_array($row->pro_type,explode("|",$configClass['show_date_search_in'])))){
		?>
		<div class="detailsBar clearfix" id="oscalendardiv">
			<div class="row-fluid">
				<div class="span12">
					<div class="shell">
