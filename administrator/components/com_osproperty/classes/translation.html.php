...
class HTML_OspropertyTranslation{
	 ...
	 */
	function translation_list($option,$trans,$lists,$pagination){
		global $mainframe,$_jversion,$configClass;
		JToolBarHelper::title(JText::_('OS_MANAGE_TRANSLATION_LIST'));
			...
			<table  width="100%">
				<tr>
					...
					<td width="70%" style="text-align:right;">
						&nbsp;&nbsp;
						Select Element: &nbsp;<?php echo $lists['element_list'];?> 
						&nbsp;<?php echo JText::_("OS_SELECT_LANGUAGE")?>: &nbsp;
						<?php echo $lists['langs'];?>
							<?php echo JText::_("OS_SELECT_SITE")?>: &nbsp;
						<?php echo $lists['site'];?>
					</td>
				</tr>
			</table>
