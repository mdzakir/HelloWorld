  ...
  loadResult : function(){
    if(this.textBox.value.length >=this.minChars){
      //document.location.href = "index.php?option=com_osproperty&task=locator_default&ajax=1&keyword="+this.textBox.value;
	 	//document.location.href = "index.php/component/osproperty/advanced-search?type_struture_stype=LIKE+%25...%25&struture_stype="+this.textBox.value;
		document.location.href = "index.php?option=com_osproperty&task=property_advsearch&list=1&type_struture_stype=LIKE+%25...%25&struture_stype="+this.textBox.value;
    }
  },
  ...
  generateResultList : function(pluginResults, actualPlugin){
    ...
    for(var j=0;j<pluginResults.length;j++){
      ...
      //  atag = dojo.create("a", {'class': "result-element", innerHTML: '<p style="text-align:left !important;padding:0px;margin:0px;font-size:12px;">'+pluginResults[j].title+'</p>'+introText, href:pluginResults[j].href}, page);
		atag = dojo.create("p", {'class': "result-element", innerHTML: introText}, page);
      //}
